...
import 'package:newflutterproject/Backend/FaceAuth/authenticate_face/scanning_animation/animated_view.dart';
import 'package:newflutterproject/Backend/FaceAuth/authenticate_face/user_details_view.dart';
import 'package:newflutterproject/Backend/FaceAuth/common/utils/custom_snackbar.dart';
import 'package:newflutterproject/Backend/FaceAuth/common/utils/extensions/size_extension.dart';
import 'package:newflutterproject/Backend/FaceAuth/common/utils/extract_face_feature.dart';
import 'package:newflutterproject/Backend/FaceAuth/common/utils/screen_size_util.dart';
import 'package:newflutterproject/Backend/FaceAuth/common/views/camera_view.dart';
import 'package:newflutterproject/Backend/FaceAuth/common/views/custom_button.dart';
import 'package:newflutterproject/Backend/FaceAuth/constants/theme.dart';
import 'package:newflutterproject/Backend/FaceAuth/model/user_model.dart';
...
class _AuthenticateFaceViewState extends State<AuthenticateFaceView> {
  ...
  Future<void> _fetchUserByName(String userName) async {
    final prefs = await SharedPreferences.getInstance();
    final keys = prefs.getKeys(); // Get all keys from SharedPreferences
    users.clear();
